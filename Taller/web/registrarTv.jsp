		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
				<div class="main-content-inner">
                    ...
                    <br>
										<div>
                      <form action="tipoVehiController" method="post" class="form-horizontal">
                        <div class="form-group">
                          <label class="col-sm-3 control-label no-padding-right">
                            Tipo De Vehiculo
                          </label>
                          <div class="col-sm-9">
                            <input type="text" name="txtTv" value="" placeholder="ID Tipo Vehículo">                            
                          </div>
                          <label class="col-sm-3 control-label no-padding-right">
                            Nombre Tipo
                          </label>
                          <div class="col-sm-9">
                            <input type="text" name="txtNomTipo" value="" placeholder="Nombre">                            
                          </div>
